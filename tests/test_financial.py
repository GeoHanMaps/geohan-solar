...
class TestCalculate:
    ...
    def test_basic_output_keys(self):
        ...
        assert {"usd_tl", "investment_usd", "investment_tl",
    ...
    def test_investment_scales_with_mw(self):
        ...
        assert r2["investment_usd"] == pytest.approx(r1["investment_usd"] * 2)
    ...
    def test_investment_tl_equals_usd_times_rate(self):
        ...
        assert result["investment_tl"] == pytest.approx(
            result["investment_usd"] * result["usd_tl"], rel=1e-3
        )
